...
class TabletSearch extends StatefulWidget {
  const TabletSearch({super.key});

  @override
  State<TabletSearch> createState() => _TabletSearchState();
}

class _TabletSearchState extends State<TabletSearch> {
      ...
      body: isFetching
          ...
          : Container(
              ...
              child: Row(
                ...
                children: [
                  Container(
                    width: 400, // Adjust the width as per your tablet layout
                    child: Column(
